        ...
        !(function(e, n) {
            ...
            function P(t, e, n, i) {
                ...
                if (
                    ...
                    if (l)
                        for (
                            c = a[a.length - 1].ownerDocument, yt.map(a, j), p = 0; p < l; p++
                        )
                            (u = a[p]),
                            Gt.test(u.type || "") &&
            ...
            yt.extend({
                    ...
                    isPlainObject: function(t) {
                        var e, n;
                        return (!(!t || "[object Object]" !== dt.call(t)) &&
                            (!(e = at(t)) ||
                                ("function" ==
                    ...
                    return i !== j && 9 === i.nodeType && i.documentElement ?
                        ((j = i),
                            ...
                            (x.getById = o(function(t) {
                                return (
                                    (O.appendChild(t).id = H), !j.getElementsByName || !j.getElementsByName(H).length
                                );
                            })),
                            x.getById ?
                ...
                return (
                    ...
                    (S = e.select = function(t, e, n, i) {
                        ...
                        if (((n = n || []), 1 === f.length)) {
                            ...
                            for (
                                o = pt.needsContext.test(t) ? 0 : r.length; o-- && ((s = r[o]), !w.relative[(a = s.type)]);
                        ...
                        return (
                            (c || E(t, f))(
                                i,
                                e, !I,
                                n, !e || (mt.test(t) && u(e.parentNode)) || e
                            ),
                            n
                        );
                    }),
                    ...
                    trigger: function(t, e, i, o) {
                        ...
                        if (
                            ...
                            if (!o && !p.noBubble && !yt.isWindow(i)) {
                                for (
                                    l = p.delegateType || d, Se.test(l + d) || (s = s.parentNode); s; s = s.parentNode
                                )
                                    f.push(s), (a = s);
                    ...
                    ajax: function(t, e) {
                        ...
                        p && 0 == yt.active++ && yt.event.trigger("ajaxStart"),
                            ...
                            ((d = h.url.slice(r.length)),
                                h.data &&
                                ((r += (Ne.test(r) ? "&" : "?") + h.data), delete h.data), !1 === h.cache &&
                                ((r = r.replace(qe, "$1")),
                                    (d = (Ne.test(r) ? "&" : "?") + "_=" + De++ + d)),
                                (h.url = r + d)),
                            h.ifModified &&
                                ...
                                r(t, [{
                                        ...
                                        value: function(t, e, n) {
                                            if (
                                                ...
                                                try {
                                                    for (
                                                        var u, c = i[Symbol.iterator](); !(r = (u = c.next()).done); r = !0
                                                    ) {
                                                        var p = u.value;
                                    ...
                                    },
                                    {
                                        ...
                                        value: function(t, e, n) {
                                            ...
                                            if (">" === i || ";" === i) {
                                                var o = "";
                                                for (
                                                    o = ">" === i ? "<" : "&"; t.substr(e - 1).charAt(0) !== o && !(--e < 0);
...
if (len[len.length - 1].startsWith("projects")) {
    $("header nav").removeClass("navbar-inverse");
    $("header nav").addClass("navbar-default");
} else {
    $("header nav").addClass("navbar-inverse");
    $("header nav").removeClass("navbar-default");
}